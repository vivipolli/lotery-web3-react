...
import FeedbackComponent, { FeedbackImgType } from "./FeedbackComponent";
...
export default function Hero() {
	...
	const [feedbackImg, setFeedbackImg] = useState<FeedbackImgType>("loading");
		...
		<Box
				...
				<Container
					...
					<Stack
						...
						<Typography
							...
							This is a decentralized app that simulates a betting platform
							using solidity, node, react, typescript and web3.js. Explore the
							universe of emerging technologies like Web3.
						</Typography>
					</Stack>
					<Box
						id="image"
			...
			<Dialog onClose={() => setOpen(false)} open={open}>
				...
				<Box
					...
					<FeedbackComponent feedbackImg={feedbackImg} />
				</Box>
			</Dialog>
		</Box>
	);
